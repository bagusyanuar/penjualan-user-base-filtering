        ...
        <div class="cart-list-container">
            ...
            <div class="cart-item-container mb-3">
                ...
                <div class="flex-grow-1">
                    <p style="color: var(--dark); font-size: 1em; margin-bottom: 0; font-weight: bold">IPhone 13 Pro
                        MAX</p>
            ...
            <div class="w-100 mb-1">
                ...
                <select id="shipment" name="shipment" class="text-input">
                    @foreach($shipments as $shipment)
                        <option value="{{ $shipment->id }}" data-price="{{ $shipment->harga }}">{{ $shipment->kota }} (Rp{{ number_format($shipment->harga, 0, ',', '.') }})</option>
                    @endforeach
                </select>
            </div>
            <div class="w-100 mb-1">
